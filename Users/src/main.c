...
void main(void)
{
  init(); // пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ
  Relay_flag = 0;
  Counter_Power_Btn = 0;
  // инициализация переменной ограничения
  ...
  {
    // Для Упонора стартовая индикация включает голубую и синюю
    // Таким образом можно идентифицировать устройства
    LED_RED_OFF;
    LED_GREEN_ON;
    LED_BLUE_ON;
    delay_ms(100);
